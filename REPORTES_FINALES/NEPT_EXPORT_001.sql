...
'' as notifier_name,
'' as Consignee_name,
EQBO.CUSTDFF_EQBO_FLEX_STRING04 as shipper_name,
EQBO.CUSTDFF_EQBO_FLEX_STRING05 as item_description,
'' as bl_no
From USRTOSN4P.inv_unit U
    LEFT OUTER JOIN USRTOSN4P.INV_UNIT_FCY_VISIT UFV           ON U.GKEY = UFV.UNIT_GKEY
    LEFT OUTER JOIN USRTOSN4P.argo_carrier_visit CV            ON (CV.GKEY = UFV.ACTUAL_OB_CV OR CV.GKEY = UFV.INTEND_OB_CV)
