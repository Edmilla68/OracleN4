...
WHERE --evnttype.ID IN ('UNIT_YARD_MOVE','UNIT_YARD_SHIFT')
     ...
     MVE.T_carry_complete >  TO_DATE('2018-12-01 00:00:00', 'YYYY-MM-DD HH24:MI:SS')
    AND MVE.T_carry_complete < TO_DATE('2018-12-02 00:00:00', 'YYYY-MM-DD HH24:MI:SS')   --MVE.T_PUT between '07/10/2019' and '08/10/2019'
