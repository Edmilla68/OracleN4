SELECT
EQBO.CUSTDFF_EDO_FLEX_DATE01 AS "FCH_REV",
...
AND EV.NOTE = U.ID 
AND EV.PLACED_TIME = (select MAX(PLACED_TIME) from USRTOSN4P.SRV_EVENT WHERE EVENT_TYPE_GKEY  = 179 AND APPLIED_TO_GKEY = EV.APPLIED_TO_GKEY AND NOTE = EV.NOTE) 
AND U.COMPLEX_GKEY = 3575349411
--AND EQBO.CUSTDFF_EDO_FLEX_DATE01 IS NULL
--AND EQBO.CUSTDFF_EDO_FLEX_DATE01 <  TO_DATE('2020-01-01 00:00:00', 'YYYY-MM-DD HH24:MI:SS')
--AND EQBO.CUSTDFF_EDO_FLEX_DATE01 >  TO_DATE('2020-01-01 00:00:00', 'YYYY-MM-DD HH24:MI:SS')-2
