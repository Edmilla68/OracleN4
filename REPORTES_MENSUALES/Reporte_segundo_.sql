...
WHERE evnttype.ID IN ('UNIT_YARD_MOVE','UNIT_YARD_SHIFT')
    AND MVE.T_PUT >=  TO_DATE('2019-10-01 00:00:00', 'YYYY-MM-DD HH24:MI:SS')
    AND MVE.T_PUT <=  TO_DATE('2019-11-01 00:00:00', 'YYYY-MM-DD HH24:MI:SS')   --MVE.T_PUT between '07/10/2019' and '08/10/2019'
