...
CASE WHEN B.NBR IS NOT NULL THEN TO_CHAR(VSD2.PUBLISHED_ETA,'DD/MM/YYYY') WHEN EQBO.NBR IS NOT NULL THEN TO_CHAR(VVD.PUBLISHED_ETA,'DD/MM/YYYY')  END AS "FECHA ETA",
